...
client_token = '6525177278:AAGOrj9hGbOXXopH24Rt1-M9265ncBCkBW0'

admin_ids = [1718738592]  # Example admin IDs
...
⊛ **Code** : `{redeem_code}`
⊛ **Bot** : @GatewayLoookupBot""")
        await client.send_message(-1001897182152,msg)
        ...
        if '.' in rw:
            ...
            if not website_url.startswith(("http://", "https://")):
                ...
                if "Error" in payment_gateways:
                    ...
                    await edit.edit(f""" ┏━━━━━━━⍟\n┃ 𝗜𝗻𝗳𝗼𝗿𝗺𝗮𝘁𝗶𝗼𝗻 𝗳𝗲𝘁𝗰𝗵𝗲𝗱 ✅\n┗━━━━━━━━━━━━⊛\n 𝗦𝗶𝘁𝗲 -» `{domain}`\n• 𝗚𝗮𝘁𝗲𝘄𝗮𝘆𝘀 ➜ unknown\n━━━━━━━━━━━━━━━\n[◈](https://i.ibb.co/CMcdMjf/Blue-Tosca-Geometric-Technology-Linkedln-Banner.png) 𝐓𝐢𝐦𝐞 𝐓𝐚𝐤𝐞𝐧 : `{rounded_time_taken}``s`\n[◈](https://i.ibb.co/CMcdMjf/Blue-Tosca-Geometric-Technology-Linkedln-Banner.png) 𝐁𝐨𝐭 [𝗚𝗮𝘁𝗲𝘄𝗮𝘆 𝗟𝗼𝗼𝗸𝘂𝗽V4](https://t.me/GatewayLoookupBot)\n❝ ━━━━・{ch}・━━━━ ❞""")
                else:
